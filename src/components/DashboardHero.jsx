...
export default function DashboardHero() {
  ...
  return (
    <section className="dashboard-hero bg-[#121212] rounded-lg h-full">
                ...
                {songs.map((song, index) => (
                  <tr key={index}>
                    ...
                    <td className="py-1 px-2 flex items-center space-x-4">
                      <img src={song.logo} alt="logo" className="w-8 h-8 rounded-lg" />
                      <div>
                        <div className="text-base font-semibold">{song.title}</div>
                        <div className="text-sm text-gray-500">{song.artist}</div>
                      </div>
                    </td>
                    <td className="py-1 px-2">{song.album}</td>
                    <td className="py-1 px-2">{song.dateAdded}</td>
                    <td className="py-1 px-2">{formatTime(song.duration)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
